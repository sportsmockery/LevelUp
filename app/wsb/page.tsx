...
const identityCards = [
  {
    title: 'Customer',
    desc: 'You pay for protection. Someone else builds the plan.',
    border: 'border-white/10',
  },
  {
    title: 'Builder',
    desc: 'You get licensed. You learn the business. You serve families directly.',
    border: 'border-[#D4AF37]/40',
  },
  {
    title: 'Leader',
    desc: 'You mentor others. You create a team. You build generational impact.',
...
const blueprintSteps = [
  {
    ...
    desc: 'The client raises their hand and requests Builder Access.',
    goal: 'Determine if they are curious, coachable, and serious enough for the next conversation.',
  },
  {
    step: 2,
    title: 'Builder Conversation',
    desc: 'Jason or Genesis has a direct conversation to understand their goals, fears, family situation, current income pressure, and why this opportunity matters.',
    goal: 'Make sure this is aligned before anyone invests money.',
  },
  {
    step: 3,
    title: 'Education Commitment',
    desc: 'Selected candidates begin the initial education step. Jason covers the $125 education fee for qualified candidates.',
    goal: 'Start with learning before licensing.',
  },
  {
    step: 4,
    title: 'License Decision',
    desc: 'Candidate decides whether to invest approximately $500 into the required licensing process.',
    goal: 'Turn interest into commitment.',
  },
  {
    step: 5,
    title: 'Mental Preparation',
    desc: 'Candidate is trained on confidence, risk, fear, rejection, communication, and emotional control before selling.',
    goal: 'Prepare the person before preparing the producer.',
  },
  {
    step: 6,
    title: 'First Client Plan',
    desc: 'Jason helps the candidate identify their first warm-market conversations and build a 14\u201330 day first-client action plan.',
    goal: 'Create a realistic path toward first production activity.',
  },
  {
    step: 7,
    title: 'First Policy / First Win',
    desc: 'Candidate learns how to serve a real family, guide the conversation, and understand the value of proper protection.',
    goal: 'Turn licensing into service and experience.',
  },
  {
    step: 8,
    title: 'Producer Rhythm',
    desc: 'Candidate develops weekly habits: conversations, follow-ups, education, mentorship, and accountability.',
    goal: 'Build consistency instead of relying on motivation.',
  },
  {
    step: 9,
    title: 'Leadership Transfer',
    desc: 'Once the candidate understands the system, they learn how to invite, educate, and mentor others.',
    goal: 'Move from selling to leading.',
  },
  {
    step: 10,
    title: 'Builder to Leader',
    desc: "The candidate becomes part of Jason and Genesis\u2019s builder culture \u2014 helping others grow while building their own business.",
    goal: 'Create leaders, not just agents.',
  },
];
...
/* ── BUILDER ACCESS FLOW (MULTI-STEP MODAL) ───────────────────────── */
...
interface FlowAnswers {
  ...
  financialAware: boolean;
  expectationsAgreed: boolean;
  name: string;
  email: string;
  phone: string;
}
...
const INITIAL_ANSWERS: FlowAnswers = {
  ...
  q3: '',
  commitConfirm: false,
  financialAware: false,
  expectationsAgreed: false,
  name: '',
  email: '',
  phone: '',
};
...
function BuilderAccessFlow({ onClose }: { onClose: () => void }) {
  ...
  const canAdvance = useCallback(() => {
    switch (step) {
      case 1:
        return answers.q1.trim() !== '' && answers.q2.trim() !== '' && answers.q3.trim() !== '';
      case 2:
        return answers.commitConfirm;
      case 3:
        return answers.financialAware;
      case 4:
        return answers.expectationsAgreed;
      case 5:
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-lg rounded-2xl border border-white/10 bg-[#0B0F1A]/95 backdrop-blur-xl p-8 shadow-2xl max-h-[90vh] overflow-y-auto"
      >
        {/* Close */}
        <button
          onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <div className="h-1.5 rounded-full bg-white/10 overflow-hidden">
            <motion.div
              className="h-full rounded-full bg-gradient-to-r from-[#D4AF37] to-[#00D4FF]"
              initial={{ width: 0 }}
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Your email client should open with your Builder Access request. Jason will follow up
              directly. Welcome to the beginning.
            </p>
            <button
              onClick={onClose}
            ...
            >
              ...
              {step === 1 && (
                <div>
                  ...
                  <label className="block mb-4">
                    <span className="text-sm text-white/70 mb-1 block">Why does financial education matter to you?</span>
                    <textarea
                      value={answers.q1}
                  ...
                  <label className="block mb-4">
                    <span className="text-sm text-white/70 mb-1 block">What excites you about becoming a builder?</span>
                    <textarea
                      value={answers.q2}
                  ...
                  <label className="block">
                    <span className="text-sm text-white/70 mb-1 block">Describe your current situation briefly.</span>
                    <textarea
                      value={answers.q3}
              ...
              {step === 2 && (
                <div>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={answers.commitConfirm}
                      onChange={(e) => setAnswers({ ...answers, commitConfirm: e.target.checked })}
                      className="mt-1 accent-[#D4AF37] w-4 h-4 shrink-0"
                    />
                    <span className="text-sm text-white/70 group-hover:text-white/90 transition-colors">
                      I understand this requires real commitment and I am ready to invest my time and effort.
                    </span>
                  </label>
                </div>
              )}
              ...
              {step === 3 && (
                <div>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={answers.financialAware}
                      onChange={(e) => setAnswers({ ...answers, financialAware: e.target.checked })}
                      className="mt-1 accent-[#D4AF37] w-4 h-4 shrink-0"
                    />
                    <span className="text-sm text-white/70 group-hover:text-white/90 transition-colors">
                      I understand that income is not guaranteed and results depend on many factors.
                    </span>
                  </label>
                </div>
              )}

              {/* STEP 4 — Pre-Frame Expectations */}
              {step === 4 && (
                <div>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input
                      type="checkbox"
                      checked={answers.expectationsAgreed}
                      onChange={(e) => setAnswers({ ...answers, expectationsAgreed: e.target.checked })}
                      className="mt-1 accent-[#D4AF37] w-4 h-4 shrink-0"
                    />
                    <span className="text-sm text-white/70 group-hover:text-white/90 transition-colors">
                      I accept these expectations and want to move forward.
                    </span>
                  </label>
                </div>
              )}
              ...
              {step === 5 && (
                <div>
                  ...
                  <label className="block mb-4">
                    <span className="text-sm text-white/70 mb-1 block">Full Name *</span>
                    <input
                      type="text"
                      value={answers.name}
                  ...
                  <label className="block">
                    <span className="text-sm text-white/70 mb-1 block">Phone (optional)</span>
                    <input
                      type="tel"
                      value={answers.phone}
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                {step < TOTAL_STEPS ? (
                  <button
                    onClick={handleNext}
                    disabled={!canAdvance()}
                    className="rounded-full bg-gradient-to-r from-[#D4AF37] to-[#B8941F] px-7 py-3 text-sm font-bold uppercase tracking-wider text-black shadow-lg shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/40 transition-all duration-300 hover:scale-105 disabled:opacity-30 disabled:hover:scale-100 disabled:cursor-not-allowed"
                  >
                    Next Step
                  </button>
                ) : (
    ...
    <main className="min-h-screen bg-[#0B0F1A] text-white overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full grid md:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeUp}>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.08] tracking-tight">
              From Customer
              <br />
              <span className="bg-gradient-to-r from-[#D4AF37] to-[#00D4FF] bg-clip-text text-transparent">
                to Builder.
              </span>
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/70 max-w-xl leading-relaxed">
              Jason and Genesis Beninato are opening the door for a select group to become licensed
              leaders inside World System Builders.
            </p>
            <p className="mt-4 text-base text-white/50 max-w-xl leading-relaxed">
              You already believe in financial education. Now you have the opportunity to learn the
              business, earn your license, serve families, and build something bigger — with
              mentorship from people who live it every day.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <button
                onClick={openFlow}
                className="inline-block rounded-full bg-gradient-to-r from-[#D4AF37] to-[#B8941F] px-8 py-4 text-sm font-bold uppercase tracking-wider text-black shadow-lg shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/40 transition-all duration-300 hover:scale-105"
              >
                Start Step 1
              </button>
              <a
                href="#blueprint"
                className="inline-block rounded-full border border-white/20 px-8 py-4 text-sm font-semibold uppercase tracking-wider text-white/80 hover:bg-white/5 transition-all duration-300"
              >
                See the Builder Blueprint
              </a>
            </div>
          </motion.div>
          <motion.div variants={fadeUp} className="relative flex justify-center">
            <div className="relative group">
              ...
              <Image
                ...
                alt="Jason and Genesis Beninato with family at financial literacy event"
                width={600}
                height={600}
                className="relative rounded-2xl shadow-2xl object-cover transition-transform duration-700 group-hover:scale-[1.03]"
                priority
              />
              <div className="absolute bottom-0 left-0 right-0 rounded-b-2xl bg-gradient-to-t from-black/70 to-transparent px-6 py-4">
                <p className="text-sm font-medium text-white/90 tracking-wide">
                  Built on family. Led with purpose.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <Section>
        <div className="mx-auto max-w-5xl text-center">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold">
            Most people stay customers.{' '}
            <span className="text-[#D4AF37]">Builders choose ownership.</span>
          </motion.h2>
          <div className="mt-16 grid md:grid-cols-3 gap-6">
            {identityCards.map((c) => (
              <motion.div
                key={c.title}
                variants={fadeUp}
                className={`rounded-2xl border ${c.border} bg-white/[0.03] backdrop-blur-md p-8 hover:bg-white/[0.06] transition-colors duration-300`}
              >
        ...
        <div className="mx-auto max-w-5xl">
          <motion.div variants={fadeUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              The <span className="text-[#D4AF37]">Builder Blueprint</span>
            </h2>
            <p className="text-white/50 max-w-2xl mx-auto leading-relaxed">
              A simple path from interested client to licensed leader — with Jason and Genesis
              guiding the process.
            </p>
          </motion.div>
            ...
            <div className="space-y-8 md:space-y-12">
              {blueprintSteps.map((s, i) => {
                ...
                return (
                  ...
                  >
                    {/* Step number dot (mobile: left, desktop: center) */}
                    ...
                    >
                      <motion.div
                        ...
                        className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-6 hover:bg-white/[0.05] transition-colors duration-300"
                      >
                        ...
                        <p className="text-xs text-[#00D4FF]/70 leading-relaxed">
                          <span className="font-semibold text-[#00D4FF]/90">Goal:</span> {s.goal}
                        </p>
                      </motion.div>
                    </div>
                  </motion.div>
          ...
          <motion.div variants={fadeUp} className="text-center mt-16">
            <button
              onClick={openFlow}
              className="inline-block rounded-full bg-gradient-to-r from-[#D4AF37] to-[#B8941F] px-10 py-4 text-sm font-bold uppercase tracking-wider text-black shadow-lg shadow-[#D4AF37]/20 hover:shadow-[#D4AF37]/40 transition-all duration-300 hover:scale-105"
            >
              Start the Builder Conversation
            </button>
          </motion.div>

          {/* Compliance */}
          <motion.p variants={fadeUp} className="text-center text-xs text-white/25 mt-8 max-w-2xl mx-auto leading-relaxed">
            This blueprint is educational and informational. Licensing approval, compensation, sales,
            and income are not guaranteed. Results depend on state requirements, carrier approvals,
            effort, skill development, market conditions, and individual performance.
          </motion.p>
        </div>
      </Section>
      ...
      <Section>
        <div className="mx-auto max-w-6xl">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-center mb-16">
            Why <span className="text-[#00D4FF]">Jason</span>
          </motion.h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyJasonCards.map((c) => (
              <motion.div
                key={c.title}
                variants={fadeUp}
                className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-8 hover:border-[#D4AF37]/30 transition-colors duration-300"
              >
      ...
      <Section>
        <div className="mx-auto max-w-3xl text-center">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold mb-6">
            The <span className="text-[#D4AF37]">Commitment</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-white/60 leading-relaxed mb-12">
            Getting started requires two things: education and licensing. Jason covers the first
            part. You invest in the second.
          </motion.p>
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <motion.div
              variants={fadeUp}
              className="rounded-2xl border border-[#D4AF37]/30 bg-white/[0.03] backdrop-blur-md p-8"
            >
              <p className="text-4xl font-bold text-[#D4AF37]">$125</p>
              <p className="text-sm text-white/50 mt-2 uppercase tracking-wider">
                Education — Covered by Jason
              </p>
            </motion.div>
            <motion.div
              variants={fadeUp}
              className="rounded-2xl border border-[#00D4FF]/30 bg-white/[0.03] backdrop-blur-md p-8"
            >
              <p className="text-4xl font-bold text-[#00D4FF]">~$500</p>
              <p className="text-sm text-white/50 mt-2 uppercase tracking-wider">
                Licensing — Your Investment
              </p>
            </motion.div>
          </div>
          <motion.div
            variants={fadeUp}
            className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 px-6 py-4 text-sm text-yellow-200/80 leading-relaxed"
          >
            This is not a guaranteed income opportunity. Licensing, compensation, and results vary
            based on effort, approvals, and many factors.
          </motion.div>
        </div>
      </Section>
      ...
      <Section>
        <div className="mx-auto max-w-3xl text-center">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold mb-6">
            One client can{' '}
            <span className="text-[#00D4FF]">change your perspective.</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-white/60 leading-relaxed mb-4">
            Imagine helping a family protect themselves with a plan that costs around $200 per month.
            As a licensed agent, you would earn a commission on that policy. One conversation. One
            family served. One step toward building something real.
          </motion.p>
          <motion.p variants={fadeUp} className="text-white/40 text-sm leading-relaxed mb-4">
            Multiply that across multiple families, and the math starts to shift — not overnight,
            but over time, with consistent effort and real mentorship.
          </motion.p>
          <motion.p
            variants={fadeUp}
            className="text-xs text-white/30 italic"
          >
            Examples are illustrative, not guaranteed. Actual compensation depends on products,
            carriers, licensing status, and individual performance.
          </motion.p>
        </div>
      </Section>
      ...
      <Section>
        <div id="curriculum" className="mx-auto max-w-5xl scroll-mt-24">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-center mb-16">
            The <span className="text-[#D4AF37]">8-Step</span> Curriculum
          </motion.h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {curriculum.map((s) => (
              <motion.div
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-6 hover:border-[#D4AF37]/40 transition-colors duration-300"
              >
                <span className="inline-block text-xs font-bold text-[#D4AF37] bg-[#D4AF37]/10 rounded-full px-3 py-1 mb-4">
                  Step {s.step}
                </span>
                <h3 className="text-base font-bold mb-2">{s.title}</h3>
      ...
      <Section>
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeUp} className="relative group flex justify-center">
            ...
            <Image
              src="/images/jason-family.jpg"
              alt="Jason and Genesis Beninato with family"
              width={560}
              height={560}
              className="relative rounded-2xl shadow-2xl object-cover transition-transform duration-700 group-hover:scale-[1.03]"
            />
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              This is built <span className="text-[#D4AF37]">together.</span>
            </h2>
            <p className="text-white/60 leading-relaxed mb-6">
              Jason and Genesis have spent years building, learning, and navigating pressure
              together. This is not theory — it is lived experience. Every lesson in the curriculum
              comes from real conversations, real setbacks, and real wins.
            </p>
            <blockquote className="border-l-2 border-[#D4AF37]/60 pl-5 text-white/80 italic leading-relaxed">
              &ldquo;We are not looking for everyone. We are looking for people ready to become
              builders.&rdquo;
            </blockquote>
      ...
      <Section>
        <div className="mx-auto max-w-4xl">
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-center mb-16">
            Is this <span className="text-[#00D4FF]">for you?</span>
          </motion.h2>
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              variants={fadeUp}
              className="rounded-2xl border border-green-500/20 bg-green-500/5 backdrop-blur-md p-8"
            >
            ...
            <motion.div
              variants={fadeUp}
              className="rounded-2xl border border-red-500/20 bg-red-500/5 backdrop-blur-md p-8"
            >
      ...
      <Section className="text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <motion.p variants={fadeUp} className="text-white/50 mb-10">
            Request access and start a conversation with Jason directly.
          </motion.p>
      ...
      <footer className="border-t border-white/5 px-6 py-12">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs text-white/30 leading-relaxed">
            Licensing, compensation, and income are not guaranteed and depend on multiple factors
            including effort, approvals, and market conditions. World System Builders and its
            affiliates make no promises regarding earnings or results. This page is an invitation to
            learn more, not a guarantee of outcome. All trademarks belong to their respective
            owners.
          </p>
        </div>
      </footer>
